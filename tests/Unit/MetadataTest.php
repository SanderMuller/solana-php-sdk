...
{
    #[Test]
    public function deserializes_metadata(): void
    {
        $metadata = Metadata::fromBuffer($this->getBuffer());

        self::assertSame(4, $metadata->key);
        self::assertSame('FeGDLocrdh5AVH5EMFsAx583hF6f7bqEaVnCE5UEzizg', $metadata->mint);
        self::assertSame(420, $metadata->data->sellerFeeBasisPoints);
    }
